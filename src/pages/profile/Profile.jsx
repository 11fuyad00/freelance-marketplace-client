              ...
              <form onSubmit={handleUpdate} className="space-y-6">
                ...
                >
                  ...
                  <div className="relative">
                    <FiEdit3 className="absolute left-4 top-1/2 transform -translate-y-1/2 text-cyan-400 text-lg" />
                    <input
                      type="text"
                      value={name}
                      onChange={e => setName(e.target.value)}
                      className="w-full pl-12 pr-4 py-4 bg-white/5 border border-cyan-400/30 rounded-2xl text-white placeholder-cyan-200/50 focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:border-transparent transition duration-300"
                ...
                >
                  ...
                  <div className="relative">
                    <FiMail className="absolute left-4 top-1/2 transform -translate-y-1/2 text-cyan-400 text-lg" />
                    <input
                      type="email"
                      value={user?.email || ''}
                      readOnly
                ...
                >
                  ...
                  <div className="relative">
                    <FiUpload className="absolute left-4 top-1/2 transform -translate-y-1/2 text-cyan-400 text-lg" />
                    <input
                      type="text"
                      value={photoURL}
                      onChange={e => {
                ...
                <AnimatePresence>
                  {imagePreview && (
                    ...
                    >
                      ...
                      <div className="border-2 border-dashed border-cyan-400/30 rounded-2xl p-6 bg-white/5">
                        <img
                          src={imagePreview}
                          alt="Preview"
                ...
                >
                  <motion.button
                    ...
                    className={`w-full py-5 px-6 rounded-2xl font-bold text-white bg-gradient-to-r from-cyan-500 to-purple-500 shadow-2xl flex items-center justify-center gap-3 transition duration-300 relative overflow-hidden ${
                      isLoading
